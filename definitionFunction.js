...
function checkOverlappedCircles() {
    for (let i = 0; i<n; i++){
        for (let j = 0; j<n;j++){
            ...
            } else return checkOverlappedCircles;
        }
    }
}
...
function collideBalls(i, j) {
    ...
    final_vy_1 = ((circles[i].mass - circles[j].mass) * new_vy_1 + (circles[j].mass + circles[j].mass) * new_vy_2) / (circles[i].mass + circles[j].mass);
    final_vy_2 = ((circles[i].mass + circles[i].mass) * new_vy_1 + (circles[j].mass - circles[i].mass) * new_vy_2) / (circles[i].mass + circles[j].mass);
